...
**Note**: The Eco Status message is kept updated by repeatedly modifying the first Discord Eco Status message. This means that the Discord bot needs permission to manage messages in the chosen channel or the message will not be updated.
